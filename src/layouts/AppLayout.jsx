...
function AppLayout() {
  ...
  return (
    <div className="relative flex h-screen overflow-hidden bg-[var(--color-gray-100)] p-[10px]">
      {/* Desktop Sidebar */}
      <div className="hidden h-full w-16 shrink-0 lg:block">
        <SidebarNavigation
          activeItem={
            activeItem ?? ''
          }
      ...
      <main className="flex min-w-0 flex-1 flex-col gap-[10px] lg:ml-[10px]">
