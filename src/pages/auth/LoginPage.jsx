  ...
  return (
    ...
    >
      <section className="flex w-full max-w-[390px] -translate-y-[12px] flex-col items-center px-6">
        <img src={logo} alt="5Pen" draggable="false" className="mb-[52px] h-auto w-[190px]" />
        ...
        <div className="flex w-full flex-col gap-[10px]">
          ...
          <div className="relative">
            <input
              ...
              className="body-5 h-[46px] w-full rounded-[8px] border border-transparent bg-[var(--color-background-subtle)] px-[14px] pr-[42px] text-[var(--color-text-primary)] transition-colors outline-none placeholder:text-[var(--color-gray-400)] focus:border-[var(--color-gray-300)]"
            />

            <div className="pointer-events-none absolute top-1/2 right-[14px] -translate-y-1/2">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                <rect x="3.5" y="3.5" width="9" height="9" rx="2" stroke="var(--color-gray-400)" />
                <path
