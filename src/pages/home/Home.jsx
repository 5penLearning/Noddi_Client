...
function Home() {
  ...
  return (
    <div className="h-full overflow-auto">
      <div className="mx-auto flex min-h-full w-full flex-col gap-[10px]">
        ...
        <div className="grid min-h-[400px] flex-1 grid-cols-[minmax(0,818px)_minmax(370px,1fr)] gap-[10px]">
