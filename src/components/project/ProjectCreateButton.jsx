    ...
    >
      <span className="relative size-6">
        ...
        <img
          ...
          className="absolute top-1/2 left-1/2 h-[1.5px] w-[7.5px] -translate-x-1/2 -translate-y-1/2"
        />
        <img
          src={plusVerticalIcon}
          className="absolute top-1/2 left-1/2 h-[1.5px] w-[7.5px] -translate-x-1/2 -translate-y-1/2 rotate-90"
        />
      </span>
    </button>
  );
